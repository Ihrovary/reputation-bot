        ...
        return Slash.of("roles", "command.roles.description")
                ...
                .group(Group.of("donor", "command.roles.donor.description")
                        .subCommand(SubCommand.of("add", "command.roles.donor.add.description")
                                ...
                                .argument(Argument.role("role", "command.roles.donor.add.options.role.description").asRequired())
                                .argument(Argument.text("access", "command.roles.donor.add.options.access.description").withAutoComplete().asRequired()))
